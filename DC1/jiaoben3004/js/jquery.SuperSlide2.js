		...
		return a.fn.slide.defaults = {
			...
			if(j.children().each(function() {
				...
				case "fold":
					...
					break;
				case "top":
					j.wrap('<div class="tempWrap" style="height:100%;overflow:hidden; position:relative;height:100%;"></div>').css({
						position: "relative",
						padding: "0",
						margin: "0",
						"height": "100%"
					...
					break;
				case "left":
					j.wrap('<div class="tempWrap" style="overflow:hidden; position:relative; width:' + s * y + 'px";height:100%;></div>').css({
						width: k * y,
						position: "relative",
						overflow: "hidden",
						padding: "0",
				...
				case "leftLoop":
				case "leftMarquee":
					j.children().clone().appendTo(j).clone().prependTo(j), j.wrap('<div class="tempWrap" style="overflow:hidden; position:relative; width:' + s * y + 'px";height:100%;></div>').css({
						width: 3 * k * y,
						position: "relative",
						overflow: "hidden",
						padding: "0",
				...
				case "topLoop":
				case "topMarquee":
					j.children().clone().appendTo(j).clone().prependTo(j), j.wrap('<div class="tempWrap" style="overflow:hidden; position:relative;height:100%;></div>').css({
						height: 3 * k * x,
						position: "relative",
						padding: "0",
						margin: "0",
